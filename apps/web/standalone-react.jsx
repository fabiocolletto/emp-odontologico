...
const FINANCIAL_DEFAULT_LANCAMENTOS = [
  ...
  },
  {
    id: 6,
    tipo: 'entrada',
    descricao: 'Consulta retorno ortodontia',
    categoria: 'Atendimento',
    subcategoria: 'Retorno',
    valor: 180,
    status: 'recebido',
    data_competencia: '2026-03-03',
  ...
  },
  {
    id: 8,
    tipo: 'entrada',
    descricao: 'Repasse convênio - março',
    categoria: 'Convênio',
    subcategoria: 'Repasse',
    valor: 3980,
    status: 'recebido',
    data_competencia: '2026-03-20',
    data_vencimento: '2026-03-20',
    data_pagamento: '2026-03-21',
    origem: 'Convênio OdontoPrev',
    paciente_id: null,
    profissional_id: null,
    observacoes: 'Lote mensal'
  },
  {
    id: 9,
    tipo: 'saida',
    descricao: 'Compra de insumos clínicos',
    categoria: 'Insumos',
    subcategoria: 'Materiais',
    valor: 2140,
    status: 'pago',
    data_competencia: '2026-03-14',
    data_vencimento: '2026-03-14',
    data_pagamento: '2026-03-14',
    origem: 'Dental Supply',
    paciente_id: null,
    profissional_id: null,
  ...
  },
  {
    id: 10,
    tipo: 'saida',
    descricao: 'Campanha mídia local',
    categoria: 'Marketing',
    subcategoria: 'Ads',
    valor: 980,
    status: 'pago',
    data_competencia: '2026-03-06',
    data_vencimento: '2026-03-10',
    data_pagamento: '2026-03-10',
    origem: 'Agência Prisma',
    paciente_id: null,
    profissional_id: null,
    observacoes: 'Campanha sazonal'
  },
  {
    id: 11,
    tipo: 'entrada',
    descricao: 'Avaliação clínica inicial',
    categoria: 'Atendimento',
    subcategoria: 'Primeira consulta',
    valor: 220,
    status: 'recebido',
    data_competencia: '2026-02-04',
    data_vencimento: '2026-02-04',
    data_pagamento: '2026-02-04',
    origem: 'Paciente Bruno',
    paciente_id: 15,
    profissional_id: 2,
  ...
  },
  {
    ...
    valor: 1740,
    status: 'recebido',
    data_competencia: '2026-02-11',
    data_vencimento: '2026-02-11',
    data_pagamento: '2026-02-12',
    origem: 'Paciente Helena',
    paciente_id: 18,
    profissional_id: 5,
    observacoes: 'Entrega em 2 etapas'
  },
  {
    id: 13,
    tipo: 'entrada',
    descricao: 'Repasse convênio - fevereiro',
    categoria: 'Convênio',
    subcategoria: 'Repasse',
    valor: 3650,
    status: 'recebido',
    data_competencia: '2026-02-24',
    data_vencimento: '2026-02-24',
    data_pagamento: '2026-02-25',
    origem: 'Convênio Uniodonto',
    paciente_id: null,
    profissional_id: null,
    observacoes: 'Lote mensal'
  },
  {
    ...
    valor: 1490,
    status: 'pago',
    data_competencia: '2026-02-16',
    data_vencimento: '2026-02-18',
    data_pagamento: '2026-02-18',
    origem: 'Tech Odonto Service',
    paciente_id: null,
    profissional_id: null,
    observacoes: 'Preventiva trimestral'
  },
  {
    id: 15,
    tipo: 'saida',
    ...
    valor: 760,
    status: 'pago',
    data_competencia: '2026-02-08',
    data_vencimento: '2026-02-15',
    data_pagamento: '2026-02-15',
    origem: 'Concessionária local',
    paciente_id: null,
    profissional_id: null,
  ...
  },
  {
    id: 16,
    tipo: 'entrada',
    descricao: 'Plano odontológico corporativo',
    categoria: 'Convênio',
    subcategoria: 'Corporativo',
    valor: 5200,
    status: 'previsto',
    data_competencia: '2026-04-26',
    data_vencimento: '2026-04-29',
    data_pagamento: '',
    origem: 'Empresa Parceira',
    paciente_id: null,
    profissional_id: null,
    observacoes: 'Faturamento em aberto'
  },
  {
    id: 17,
    tipo: 'saida',
  ...
  },
  {
    id: 18,
    tipo: 'saida',
    descricao: 'Laboratório ortodôntico',
    categoria: 'Laboratório',
    subcategoria: 'Ortodontia',
    valor: 2340,
    status: 'pago',
    data_competencia: '2026-03-27',
    data_vencimento: '2026-03-29',
    data_pagamento: '2026-03-29',
    origem: 'Lab Ortodonto Prime',
    paciente_id: null,
    profissional_id: null,
    observacoes: '8 dispositivos'
  }
];
